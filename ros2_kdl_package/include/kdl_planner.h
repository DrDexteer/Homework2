...
public:
    ...
    KDLPlanner(double _trajDuration, Eigen::Vector3d _trajInit, double _trajRadius); //circle traj
    trajectory_point compute_trajectory_circle(double t,double tc=0);

    KDLPlanner(double _trajDuration, Eigen::Vector3d _trajInit, Eigen::Vector3d _trajEnd); //linear traj
    trajectory_point compute_trajectory_linear(double t, double tc=0);
